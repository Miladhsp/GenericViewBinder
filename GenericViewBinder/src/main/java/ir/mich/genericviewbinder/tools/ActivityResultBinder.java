...
public class ActivityResultBinder<Input, Result> {
    ...
    public static <Input, Result> ActivityResultBinder<Input, Result> registerForActivityResult(
            ...
            @NonNull ActivityResultContract<Input, Result> contract,
            @Nullable OnActivityResult<Result> onActivityResult) {
        return new ActivityResultBinder<>(caller, contract, onActivityResult);
    }
     ...
     */
    @NonNull
    public static ActivityResultBinder<Intent, ActivityResult> registerActivityForResult(
            @NonNull ActivityResultCaller caller) {
